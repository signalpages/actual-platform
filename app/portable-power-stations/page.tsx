...
export const metadata: Metadata = {
    ...
    description: 'Independent forensic audits of portable power stations. Verified specifications, Verification Scoring, and side-by-side comparisons of top solar generators.',
};
        ...
        <main className="bg-white min-h-screen">
            ...
            <section className="py-16 px-6">
                <div className="max-w-5xl mx-auto space-y-16">
                    ...
                    {/* Verification Score Table */}
                    <div>
                        <div className="flex items-center justify-between mb-8">
                            <h2 className="text-2xl font-black uppercase tracking-tighter text-slate-900">Verification Score Rankings</h2>
                        ...
                        {sortedProducts.length === 0 ? (
                            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-12 text-center">
                                ...
                                <p className="text-slate-500 text-sm max-w-md mx-auto">
                                    We are currently processing the baseline audits for this category. Check back soon for verified Verification Scores.
                                </p>
                            </div>
                        ) : (
                                ...
                                <table className="w-full text-left border-collapse min-w-[800px]">
                                    <thead>
                                        <tr className="bg-slate-50 border-b border-slate-200">
                                            ...
                                            <th className="p-4 text-[10px] font-black uppercase tracking-widest text-slate-500 w-1/6">Verification Score</th>
                    ...
                    <div className="bg-slate-50 border border-slate-200 p-8 rounded-2xl max-w-3xl">
                        ...
                        <p className="text-sm text-slate-600 leading-relaxed">
                            A high Verification Score means the unit reliably delivers its advertised specifications under normal operating stress, without hidden caveats in the manual or regulatory filings.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 pt-8 border-t border-slate-100">
                        ...
                        <Link href="/methodology" className="group p-6 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
                            ...
                            <p className="text-xs text-slate-500 leading-relaxed">Read about the four-stage validation framework used to calculate the Verification Score.</p>
                        </Link>
