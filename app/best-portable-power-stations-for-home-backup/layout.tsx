...
export const metadata: Metadata = {
    ...
    description: 'Independent analysis of portable power stations for home backup. Filters by continuous output (2000W+), capacity, and verified Verification Score.',
    alternates: {
